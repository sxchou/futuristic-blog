        ...
        <template v-else-if="profile">
          ...
          <div v-if="profile.tech_stack?.length" class="glass-card p-8 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <h3 class="text-base font-semibold text-gray-900 dark:text-white mb-3">{{ stack.category }}</h3>
            ...
            <div class="relative">
              ...
              >
                ...
                <div class="glass-card-hover p-6">
                  ...
                  <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">{{ item.position }}</h3>
          ...
          <div v-if="profile.education" class="glass-card p-8 mb-8">
            ...
            <div class="glass-card-hover p-6 inline-block">
              ...
              <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">{{ profile.education.school }}</h3>
          ...
          <div v-if="socialLinksStore.hasSocialLinks" class="glass-card p-8">
            <h2 class="text-xl md:text-2xl font-bold mb-6 flex items-center gap-3">
            ...
            <div class="flex flex-wrap gap-4">
              <a
                ...
                :class="['flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-dark-100/50 border border-gray-200 dark:border-white/10 rounded-lg transition-colors', link.color, link.hoverColor]"
              >
                ...
                <svg v-else-if="link.icon === 'email'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <svg v-else-if="link.icon === 'blog'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
