  ...
  <div class="flex items-center justify-center px-4 pt-8 pb-32">
    <div class="w-full max-w-md">
      ...
      <div v-else class="space-y-6">
        ...
        <div v-if="!showChangeEmailForm" class="space-y-4">
        ...
        <div class="text-center">
          <router-link to="/login" class="text-sm text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition">
            返回登录
          </router-link>
        </div>
      </div>
