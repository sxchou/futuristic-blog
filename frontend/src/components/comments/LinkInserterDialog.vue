  ...
  >
    <div class="bg-white dark:bg-dark-100 rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
      <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-white/10">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">插入链接</h3>
        <button
          @click="close"
      ...
      <div class="p-4">
        ...
        <div v-else-if="activeTab === 'article'" class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              搜索文章
            </label>
        ...
        <div v-else-if="activeTab === 'file'" class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              搜索文件
            </label>
          ...
          <div v-else class="max-h-60 overflow-y-auto space-y-2">
            ...
            <div v-if="filteredFiles.length === 0" class="text-center py-8 text-gray-500 dark:text-gray-400">
              没有找到相关文件
            </div>
          </div>
      ...
      <div class="flex justify-end gap-2 p-4 border-t border-gray-200 dark:border-white/10">
        <button
          @click="close"
          class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-dark-200 rounded-lg hover:bg-gray-200 dark:hover:bg-dark-300 transition-colors"
        >
          取消
        </button>
        <button
