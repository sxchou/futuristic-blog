...
<template>
  ...
  >
    <div class="bg-white dark:bg-dark-100 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
      ...
      <form class="p-3 overflow-y-auto flex-1" @submit.prevent="insertLink">
        ...
        >
          <div>
            <label for="input-externalUrl" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
              链接地址 <span class="text-red-500">*</span>
            </label>
            <input id="input-externalUrl"
              v-model="externalUrl"
              type="url"
          ...
          <div>
            <label for="input-externalText" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
              链接文本
            </label>
            <input id="input-externalText"
        ...
        >
          <div>
            <label for="input-article-searchQuery" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
              搜索文章
            </label>
            <input id="input-article-searchQuery"
              v-model="searchQuery"
              type="text"
              placeholder="输入关键词搜索..."
              class="input-cyber w-full text-sm"
          ...
          <div
            ...
            class="mt-3"
          >
            <label for="input-article-linkText" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
              链接文本
            </label>
            <input id="input-article-linkText"
              v-model="linkText"
              type="text"
        ...
        >
          <div>
            <label for="input-file-searchQuery" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
              搜索文件
            </label>
            <input id="input-file-searchQuery"
              v-model="searchQuery"
              type="text"
              placeholder="输入文件名搜索..."
              class="input-cyber w-full text-sm"
          ...
          <div
            ...
            class="mt-3"
          >
            <label for="input-file-linkText" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
              链接文本
            </label>
            <input id="input-file-linkText"
              v-model="linkText"
              type="text"
