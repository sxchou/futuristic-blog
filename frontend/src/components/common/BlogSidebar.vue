...
<template>
  <aside class="blog-sidebar">
    ...
    <div class="sidebar-widget">
      <h3 class="sidebar-widget-title flex items-center gap-2">
        <svg
      ...
      <div class="grid grid-cols-2 gap-3">
        <div class="text-center p-2 bg-gray-50 dark:bg-dark-300/50 rounded-lg">
          <svg
            class="w-5 h-5 mx-auto mb-1 text-primary"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="text-center p-2 bg-gray-50 dark:bg-dark-300/50 rounded-lg">
          <svg
            class="w-5 h-5 mx-auto mb-1 text-accent"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="text-center p-2 bg-gray-50 dark:bg-dark-300/50 rounded-lg">
          <svg
            class="w-5 h-5 mx-auto mb-1 text-cyber-pink"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="text-center p-2 bg-gray-50 dark:bg-dark-300/50 rounded-lg">
          <svg
            class="w-5 h-5 mx-auto mb-1 text-cyber-green"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
