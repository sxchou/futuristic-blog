      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="md:col-span-2">
          ...
          <div class="flex gap-2">
            <a href="https://github.com" target="_blank" class="p-1.5 rounded-lg bg-gray-100 dark:bg-dark-100/50 border border-gray-200 dark:border-white/10 hover:border-primary/50 hover:text-primary transition-colors">
            ...
            <a href="mailto:hello@futuristic-blog.com" class="p-1.5 rounded-lg bg-gray-100 dark:bg-dark-100/50 border border-gray-200 dark:border-white/10 hover:border-primary/50 hover:text-primary transition-colors">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </a>
            <a href="#" class="p-1.5 rounded-lg bg-gray-100 dark:bg-dark-100/50 border border-gray-200 dark:border-white/10 hover:border-primary/50 hover:text-primary transition-colors">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
