    ...
    <Transition name="mfs">
      <div v-if="isOpen" class="mfs-overlay">
        <div class="mfs-layout">
          <div class="mfs-toolbar tooltip-below">
            <button class="mfs-btn" @click="copySource" :data-tooltip="isCopied ? '已复制' : '复制源码'">
            ...
            <button class="mfs-btn" @click="zoomOut" :disabled="scale <= MIN_SCALE" data-tooltip="缩小 (-)">
            ...
            <button class="mfs-btn" @click="zoomIn" :disabled="scale >= MAX_SCALE" data-tooltip="放大 (+)">
            ...
            <div class="mfs-sep"></div>
            <button class="mfs-btn" @click="resetZoom" data-tooltip="重置缩放 (0)">
            ...
            <div class="mfs-sep"></div>
            <button class="mfs-btn" @click="close" data-tooltip="关闭 (Esc)">
