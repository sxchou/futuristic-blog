...
<template>
  <section class="relative overflow-hidden pb-12 md:pb-16">
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        class="absolute -bottom-40 -left-40 w-80 h-80 bg-accent/10 rounded-full blur-3xl animate-pulse"
                ...
                <div class="flex flex-col md:flex-row gap-4 md:gap-6">
                  ...
                  <div class="flex-1 flex flex-col justify-center">
                    ...
                    <p
                      ...
                      class="text-gray-500 dark:text-gray-400 text-sm md:text-base mb-3 line-clamp-2"
                    >
                      {{ article.summary }}
                    </p>
