...
async def get_public_stats(
    ...
    cache_manager.set(CACHE_NAME, cache_key, result.model_dump())
    return result
...
async def get_overview_stats(
    ...
    cache_manager.set(CACHE_NAME, cache_key, result, ttl=120)
    return result
...
async def get_views_trend(
    ...
    cache_manager.set(CACHE_NAME, cache_key, result, ttl=300)
    return result
