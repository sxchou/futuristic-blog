...
async def get_user_bookmarks(
    ...
    query = db.query(ArticleBookmark).options(
        joinedload(ArticleBookmark.article).joinedload(Article.category),
        joinedload(ArticleBookmark.article).selectinload(Article.tags),
        joinedload(ArticleBookmark.article).joinedload(Article.author)
    ).filter(
        ArticleBookmark.user_id == current_user.id
